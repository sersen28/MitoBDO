namespace MitoBDO.Constants
{
	public static class CustomID
	{
		...
		public const string CompleteParty = nameof(CompleteParty);

		public const string PartyTitle = nameof(PartyTitle);
		public const string PartyDescription = nameof(PartyDescription);
	}
}
